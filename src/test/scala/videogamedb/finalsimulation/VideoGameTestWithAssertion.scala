...
class VideoGameTestWithAssertion extends Simulation {
  ...
  val scenario_final = scenario("Video Game DB Assertion Script")
    .forever{
  ...
  after{
    println("Assertion Test is Completed for VideoGame DB")
